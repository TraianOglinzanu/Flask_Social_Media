...
from hockeyblog.models import BlogPost
from hockeyblog.blog_posts.forms import BlogPostForm
...
def update(blog_post_id):
    ...
    if form.validate_on_submit():
        ...
        blog_post.title = form.title.data, text=form.text.data, user_id=current_user.id
